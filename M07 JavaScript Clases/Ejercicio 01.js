...
function agregarStringInvertida() {
   ...
   String.prototype.reverse = function () {
      var stringArray = this.split("");//IMPORTANTE siempre el This para indicar el contexto.
      var inversion = stringArray.reverse();//los metodos siempre llevan parentesis.
      var stringInvertido = inversion.join("");
